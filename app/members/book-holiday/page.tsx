...
import { FaMapMarkerAlt, FaCalendarAlt, FaUserFriends, FaCoins, FaConciergeBell } from 'react-icons/fa';

const exclusiveResorts = [
  { name: "Rosewood Maldives Resort", points: "2,500 / Night", img: "/img/location/loc2.webp" },
  { name: "Swiss Alps Chalet", points: "1,800 / Night", img: "/img/location/loc4.webp" },
  { name: "Kyoto Heritage Villa", points: "2,100 / Night", img: "/img/location/loc6.webp" },
];
    ...
    <main className="bg-[#f0f9f9] min-h-screen pb-24">
      ...
      <section className="container mx-auto px-4 -mt-16 relative z-20">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center mb-10 border-b border-gray-100 pb-8">
            <div>
              <h2 className="text-3xl font-bold text-[#004b62]">Welcome Back, Member!</h2>
              <p className="text-gray-500 mt-2">Use your membership points to book your next getaway.</p>
            </div>
            <div className="mt-6 md:mt-0 bg-[#fcf8f1] px-8 py-4 rounded-2xl text-center border border-[#fbbf24]/30">
              <span className="block text-sm text-gray-500 font-bold uppercase tracking-wider mb-1">Available Points</span>
              <span className="text-3xl font-black text-[#fbbf24] flex items-center justify-center gap-2">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gray-50 p-4 rounded-2xl flex items-center gap-4 focus-within:ring-2 ring-[#a3e635] transition-all">
              ...
              <div className="flex-1">
                <label className="block text-xs font-bold text-gray-400 uppercase">Check In - Out</label>
                <input type="text" placeholder="Select Dates" className="w-full bg-transparent font-bold text-[#004b62] outline-none placeholder:text-[#004b62]" />
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-2xl flex items-center gap-4 focus-within:ring-2 ring-[#a3e635] transition-all">
              ...
              <div className="flex-1">
                <label className="block text-xs font-bold text-gray-400 uppercase">Guests</label>
                <select className="w-full bg-transparent font-bold text-[#004b62] outline-none cursor-pointer">
      ...
      <section className="container mx-auto px-4 mt-24">
        <div className="text-center mb-12">
          <span className="text-[#a3e635] font-bold uppercase tracking-widest bg-[#004b62] px-4 py-1 rounded-full text-xs">Exclusive Access</span>
          <h2 className="text-4xl font-bold text-[#004b62] mt-6">Trending Member Destinations</h2>
        </div>
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-black/40 backdrop-blur-md text-white text-xs font-bold px-4 py-2 rounded-full flex items-center gap-2 border border-white/20">
                  <FaCoins className="text-[#fbbf24]" /> {resort.points}
                </div>
              </div>
              <div className="p-8 text-center">
                <h3 className="text-2xl font-bold text-[#004b62] mb-4">{resort.name}</h3>
      ...
      <section className="container mx-auto px-4 mt-24">
        <div className="bg-[#004b62] rounded-[40px] p-12 md:p-16 flex flex-col md:flex-row items-center justify-between shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 md:w-2/3 mb-8 md:mb-0 text-center md:text-left">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Need Custom Arrangements?</h2>
            <p className="text-gray-300 text-lg">Contact your dedicated VIP Concierge to arrange yacht rentals, private chefs, or complex multi-destination itineraries.</p>
          </div>
